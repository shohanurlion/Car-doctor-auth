...
const Register = () => {
    ...
    const regHandel = (e)=>{
        ...
        // console.log(email, password, firstname, lastname, phone, company);
...
<Helmet>
<meta charSet="utf-8" />
<title>Regetiona </title>
</Helmet>
<div className='py-8 text-center'>
    <h1 className='text-6xl'>Regetiona Now </h1>
</div>
<form class="max-w-md mx-auto" onSubmit={regHandel}>
